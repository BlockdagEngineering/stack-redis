...
class StackNamingCoherenceTests(unittest.TestCase):
    def test_compose_dashboard_exports_current_container_names(self) -> None:
        ...
        self.assertIn("BDAG_STATUS_SOURCE_URL: http://dashboard:8088/api/status", compose)
        self.assertIn("BDAG_SENTINEL_STATUS_URL: http://dashboard:8088/api/status", compose)
    ...
    def test_env_examples_and_installer_use_current_names(self) -> None:
        ...
        self.assertIn("NODE_RPC_URLS=http://127.0.0.1:38131", env_example)
    ...
    def test_release_installer_generates_current_runtime_topology(self) -> None:
        ...
        self.assertIn('set_env_value .env POOL_RPC_BACKENDS "node=http://127.0.0.1:38131"', installer)
