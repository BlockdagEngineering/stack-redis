...
BDAG_WATCHDOG_NATIVE_P2P_PEER_LOSS_REPAIR_SECONDS=$(stack_default BDAG_WATCHDOG_NATIVE_P2P_PEER_LOSS_REPAIR_SECONDS)
...
ensure_stack_default_env_value BDAG_WATCHDOG_NATIVE_P2P_PEER_LOSS_REPAIR_SECONDS
